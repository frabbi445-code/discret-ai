...
# 📚 ৬. গ্লোবাল লেকচার ডাটাবেস এবং ইন্টারঅ্যাক্টিভ লেসন জেনারেটর (একত্রিত ও ভ্যালিডেটেড)
...
st.caption("💡 পরীক্ষার আগে ডিসক্রিট ম্যাথের গুরুত্বপূর্ণ জটিল সূত্রগুলো দ্রুত রিভিশন দেওয়ার ইন্টারেক্টিভ ফ্লিপ-বক্স।")
...
with f_col2:
    ...
    if st.checkbox("Reveal Formula 2"):
        st.info(r"$$\lceil n/k \rceil \text{ pigeons per hole.}$$")

st.write("---")

# 🤖 ৮. AI Smart PDF / Lecture Note Explainer Simulation
st.markdown("<h3 style='color: #38bdf8;'>🤖 AI Smart Lecture Note Explainer</h3>", unsafe_allow_html=True)
st.caption("💡 Presidency University ক্লাসরুমের ডিসক্রিট ম্যাথ লেকচার শিট বা পিডিএফ (PDF) আপলোড করে ইনস্ট্যান্ট সাজেশন জেনারেট করো।")
...
if uploaded_file is not None:
    with st.spinner("🤖 AI is reading and analyzing your university note..."):
        ...
        st.markdown("""
            ...
            <b>📌 AI Generated Short Suggestion & Summary:</b><br><br>
