    ...
    if provider_name == "OpenAI":
        ...
        for url_template in gateways:
            ...
            try:
                ...
                # কোটা শেষ হয়ে গেলে (Status 429) মার্জিত মেসেজ দেওয়ার লজিক
                if res.status_code == 429:
                    return "⚠️ Gemini API-এর ফ্রি লিমিট শেষ হয়ে গেছে! অনুগ্রহ করে ১ মিনিট পর আবার চেষ্টা করুন অথবা অন্য কোনো API Key ব্যবহার করুন।", False
        ...
        return "Gemini API রেসপন্স করতে পারছে না। অনুগ্রহ করে কী (Key) চেক করুন।", False
    ...
    if not final_key:
        ...
        with st.spinner("Processing with AI..."):
            ...
            if success:
                ...
                # এখানে সেই জঘন্য এররের বদলে সুন্দর ওয়ার্নিং বক্স দেখাবে!
